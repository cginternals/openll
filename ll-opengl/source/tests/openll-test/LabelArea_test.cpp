...
{
    gloperate_text::LabelArea a {{0.f, 0.f}, {2.f, 2.f}};
    gloperate_text::LabelArea b {{1.f, 1.f}, {2.f, 2.f}};
    ...
    gloperate_text::LabelArea c {{0.f, 1.f}, {3.f, 2.f}};
    gloperate_text::LabelArea d {{1.f, 0.f}, {1.f, 4.f}};
    ...
    gloperate_text::LabelArea e {{0.f, 0.f}, {4.f, 2.f}};
    gloperate_text::LabelArea f {{0.f, 3.f}, {2.f, 2.f}};
