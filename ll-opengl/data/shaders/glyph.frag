...
void main()
{
    ...
    float a;
    switch (g_superSampling)
    {
    case SuperSamplingNone:     a =            tex(0.5, g_uv); break;
    case SuperSampling1x3:      a =      aastep1x3(0.5, g_uv); break;
    case SuperSampling2x4:      a =      aastep2x4(0.5, g_uv); break;
    case SuperSampling2x2RGSS:  a =  aastep2x2RGSS(0.5, g_uv); break;
    case SuperSamplingQuincunx: a = aastepQuincunx(0.5, g_uv); break;
    case SuperSampling8Rooks:   a =   aastep8Rooks(0.5, g_uv); break;
    case SuperSampling3x3:      a =      aastep3x3(0.5, g_uv); break;
    case SuperSampling4x4:      a =      aastep4x4(0.5, g_uv); break;
    }
